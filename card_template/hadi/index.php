...
$html_str .= '#garis{transform: rotateZ(270deg);position:absolute; left: 186px;top: 79px;width:205px;height: 45px;}'."\n";
$html_str .= '#rules_div{-moz-transform:rotateZ(270deg);z-index:4;position: absolute;left: 65px;top:30px;width:165px;height: 142px;text-align: justify;}'."\n";
$html_str .= '#address_div{-moz-transform:rotateZ(270deg);z-index:4;position: absolute;left: 200px;top: 80px;width:200px;height: 30px;font-size:7px;color: #000000;font-weight: bold;}'."\n";
$html_str .= '#logo_div{-moz-transform:rotateZ(90deg);z-index:5;position: absolute;left: 275px;top: 5px;}'."\n";
$html_str .= '#photo_blank_div{-moz-transform:rotateZ(90deg);z-index:5;position: absolute;left: 115px;top:50px;font-size: 7px;text-align: center;border:#cccccc solid 1px;width:'.(($sysconf['membercard_print_settings']['card_photo_width']-0.2)*37.795275591).'px; height:'.(($sysconf['membercard_print_settings']['card_photo_height']-0.2)*37.795275591).'px;}'."\n";                                                                       //Jushadi  A r m an   S az
...
$html_str .= '.stempel_div{-moz-transform:rotateZ(270deg);z-index:11;position: absolute;left: 145px;top:75px;margin-bottom: 34px;width: 160px;}'."\n";
...
$html_str .= '.gambar_ttd_div{z-index:16;position: absolute;left: 15px;top: 20px;width:107px;height: 25px;}'."\n";
...
$html_str .= '<div id="address_div">'.$sysconf['membercard_print_settings']['card_address'].'</div>'; // Jushadi  Arman Saz
...
$html_str .= '<p class="stempel pejabat">'.$sysconf['membercard_print_settings']['card_officials'].'</br>'.$sysconf['membercard_print_settings']['card_officials_id'].'</p></div></div>'.( $sysconf['membercard_print_settings']['card_show_back_stamp']?'':'-->').''; // Jushadi Arman  Saz
$html_str .= '</td>';
        }
        $html_str .= '<tr>'."\n";
    }
