...
$sysconf['card']['dir'] = 'card_template';
$sysconf['card']['theme'] = 'default';
$sysconf['card']['css'] = $sysconf['card']['dir'].'/'.$sysconf['card']['theme'].'/style.css';
...
$sysconf['date_format'] = 'd-m-Y'; /* Produce 2009-12-31 */
