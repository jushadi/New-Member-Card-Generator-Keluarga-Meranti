...
if (isset($_POST['updateSettings'])) {
 ...
 // template Jushadi Arman Saz
    ...
    // write log
    utility::writeLogs($dbs, 'staff', $_SESSION['uid'], 'membership', $_SESSION['realname'].' change '.$setting_type.' print settings');
...
$form->addAnything(__('Senayan Version'), '<strong>'.SENAYAN_VERSION.'</strong>');
$form->addAnything(__('Print setting for'), ucwords($type).' lite version by Jushadi Arman Saz');  
